          ...
          <>
            ...
            <motion.div
              ...
              style={{
                ...
                width: '80%',
                maxWidth: '350px',
                background: 'var(--glass-bg)', // Utilizes glassmorphic theme variable
                ...
                overflowY: 'auto' // Enables vertical scrolling when menu content overflows small viewports
              }}
            >
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
                ...
                <button onClick={() => setIsOpen(false)} style={{ background: 'none', border: 'none', color: 'var(--text-primary)', fontSize: '1.5rem', cursor: 'pointer' }}>&times;</button>
              </div>
              ...
              {navLinks.map((link, i) => (
                <motion.a
                  ...
                  style={{
                    fontSize: '2.5rem',
                    fontWeight: 800,
                    color: 'var(--text-primary)', // Matches theme mode text color
                    textDecoration: 'none',
                    fontFamily: 'var(--font-heading)',

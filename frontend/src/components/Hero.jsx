      ...
      >
        ...
        >
          <p style={{ color: 'var(--text-secondary)', fontSize: '1.1rem', lineHeight: 1.8, maxWidth: '450px' }}>
            Hi, I'm Om — a MERN Stack Developer passionate about building modern, scalable, and user-focused web applications. I transform ideas into responsive digital experiences using React, Node.js, Express.js, MongoDB, and TypeScript while continuously exploring new technologies to create better software.
